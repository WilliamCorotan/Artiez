        ...
        <>
            ...
            <Layout auth={auth}>
                ...
                <section className="relative flex">
                    ...
                    <div className="grid items-center justify-center min-h-screen px-4 w-screen py-12 md:px-8 lg:py-24 bg-[url('assets/artiez.svg')] bg-no-repeat bg-cover ">
                        <div className="bg-neutral-50 py-4 px-6 bg-opacity-80">
                            <div className="flex flex-col items-center mb-5">
                                <h1 className="inline text-center text-3xl md:text-5xl z-10">
                                    Welcome Artiezan
                                </h1>
                            ...
                            <form
                                onSubmit={submit}
                                className="mt-8 mb-0 space-y-4 mx-auto"
                            >
                                ...
                                <div className="flex flex-col md:flex-row items-center justify-between">
                                    <button
                                        type="submit"
                                        className="md:order-2 w-full md:w-fit md:inline-block rounded-lg bg-sky-600 px-5 py-3 text-sm font-medium text-white"
                                    >
                                        Sign in
                                    </button>
                                    <p className="md:order-1 text-xs mt-2 text-gray-900">
                                        No account? {""}
                                        <Link
                                            href="/register"
                                            className="underline"
