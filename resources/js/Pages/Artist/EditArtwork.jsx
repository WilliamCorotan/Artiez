                                            ...
                                            <div className="mt-1 flex justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                                                {source ? (
                                                    <div className="w-full">
                                                        ...
                                                        <InputLabel
                                                            for="product_preview"
                                                            className="relative mt-2 text-right cursor-pointer rounded-md bg-white font-medium text-rose-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-rose-600 focus-within:ring-offset-2 hover:text-rose-600"
                                                        >
                                                            <span>
                                                                Upload another
                                                                image
