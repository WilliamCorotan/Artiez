  ...
  <div className="md:grid md:grid-cols-6 md:gap-6">
    <div className="md:col-span-6">
      <div className="px-4 sm:px-0">
        <h3 className="text-center text-lg font-medium leading-6 text-gray-900">Artwork Details</h3>
        <p className="mt-1 text-sm text-gray-600">Please fill out the given fields</p>
      </div>
    </div>
      ...
      <form onSubmit={submit} method="POST">
        <div className="shadow sm:overflow-hidden sm:rounded-md">
          ...
          <div className="grid grid-cols-6 gap-6">
            ...
            {/* Artwork description */}
            <div className="col-span-6">
              <InputLabel forInput="description" className="block text-sm font-medium text-gray-700">Desciption</InputLabel>
                <textarea 
                    id="description" 
                    name="description" 
                    className=" mt-1 block w-full h-32 rounded-md border-gray-300 shadow-sm focus:border-rose-600 focus:ring-rose-600 sm:text-sm" placeholder="desciption goes here..."
                    value={data.description}
                    onChange={onHandleChange}/>

              <p className="mt-2 text-sm text-gray-500">Brief description for your artwork.</p>
            </div>
            {/* Product preview */}
            <div className="col-span-6">
              <label className="block text-sm font-medium text-gray-700">Product Preview</label>
            ...
            <div className="col-span-6 md:col-span-3">
                ...
                >
                    ...
                    <option value="Soft Fabric" >Soft Fabric</option>
                    <option value="Others" >Others</option>
                </select>
            </div>
            {/* Artwork art style */}
            <div className="col-span-6">
                ...
                <select 
                    ...
                    onInput={onHandleChange}
                >
                    <option >-Please select an art style-</option>
          ...
          <div className="bg-gray-50 px-4 py-3 text-right sm:px-6">
            <button type="submit" className="inline-flex justify-center rounded-md border border-transparent bg-rose-500 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-rose-600 focus:outline-none focus:ring-2 focus:ring-rose-600 focus:ring-offset-2">Save</button>
          </div>
        </div>
      </form>
    </div>
