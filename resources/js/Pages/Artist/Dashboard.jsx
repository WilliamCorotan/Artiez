                ...
                <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
                    ...
                    <div className="relative grid gap-6">
                        ...
                        <div className="relative border-t-2 p-4 pt-8 border-rose-200 ">
                            <h3 className="absolute -top-5 right-4 bg-white uppercase font-bold text-sm border-2 border-rose-200 rounded-full p-2">
                                Latest Artworks
                            </h3>
                        </div>
                        <div className="grid md:grid-cols-2 gap-10">
                            <Link
                                ...
                                className=" w-full h-96 lg:h-full mb-5 rounded-md shadow-lg border-2 grid place-content-center transition ease-in-out delay-15 hover:-translate-y-0.5 hover:scale-110 hover:bg-white duration-300"
                            >
                                Add Artwork
                            </Link>
                            {/* Total artworks */}
