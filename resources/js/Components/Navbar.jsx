                    ...
                    <div className="flex md:order-2">
                        <div className="relative hidden md:block">
                            ...
                            <TextInput
                                type="text"
                                id="search-navbar"
                                className="block w-full p-2 pl-10 text-sm text-gray-900 border border-red-800 rounded-lg bg-gray-50 focus:ring-red-900 focus:border-red-800"
                                placeholder="Search"
                            />
                        </div>
                        <button
                            ...
                            type="button"
                            className="inline-flex items-center p-2 text-sm text-red-800 rounded-full md:hidden hover:bg-gray-100 focus:outline-none  focus:bg-red-800 focus:text-white "
                    ...
                    >
                        <div className="relative mt-3 md:hidden">
                            ...
                            <TextInput
                                type="text"
                                id="search-navbar"
                                className="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-red-900 focus:border-red-800"
                                placeholder="Search..."
                            />
                        </div>
