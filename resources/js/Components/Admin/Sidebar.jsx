      ...
      >
        ...
        <div>
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3 lg:pl-0">
              <img src={asset('assets/Artiez.svg')} alt="Artiez Logo" className='w-1/5 lg:w-full' />
            </h3>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div>
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Collections</span>
            </h3>
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0`}>
                ...
                >
                  <div className="flex items-center">
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Add Artwork</span>
                  </div>
                </NavLink>
              </li>
              {/* Gallery */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0`}>
                ...
                >
                  <div className="flex items-center">
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Gallery</span>
                  </div>
                </NavLink>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-xs uppercase text-slate-500 font-semibold pl-3">
              ...
              <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Transactions</span>
            </h3>
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0`}>
                ...
                >
                  <div className="flex items-center">
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Sold Artworks</span>
                  </div>
                </NavLink>
              </li>
            </ul>
