...
export const ArtworkCard = ({ artworks, className }) => {
    ...
    return (
        <>
            <div className={`w-full grid mb-5 transition ease-in-out delay-15 hover:-translate-y-0.5 hover:scale-110 hover:bg-white duration-300 rounded-md shadow-lg border-2 ${className}`}>
