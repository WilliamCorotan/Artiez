        ...
        <>
            <footer className="bg-gray-200">
                <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
                    <div>
                        <h2 className="mb-6 text-sm font-bold text-red-800 uppercase">
                            Artiez Gallery
                        </h2>
                ...
                <div className="px-4 py-6 bg-red-900 md:flex md:items-center md:justify-between">
                    <span className="text-sm text-white sm:text-center">
                        © 2023 <a href="/">ArtVengers</a>. All Rights Reserved.
                    </span>
