...
export const Card = ({ artworks }) => {
    ...
    return (
        <>
            <div className="max-w-xs md:max-w-sm mb-5 transition ease-in-out delay-15 hover:-translate-y-0.5 hover:scale-110 hover:bg-white duration-300 rounded-md shadow-lg border-2">
                <Link
                    to="Homepage"
                ...
                >
                    <img
                        className="rounded-t-md w-full h-64  object-cover object-center"
                        src={asset(`assets/artwork/${artworks.product_preview}`)}
                        alt={artworks.product_name}
                    />
                </Link>
                <div className="p-5 h-44 table-fixed text-gray-800">
