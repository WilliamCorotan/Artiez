    ...
    return (
        <Link
            ...
            className={
                ...
                active ? `block text-lg py-2 pl-3 pr-4 text-rose-400 hover:text-rose-600  hover:border-b-2
                hover:border-rose-600 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out ${className}` : `block text-lg py-2 pl-3 pr-4  text-gray-600 hover:text-rose-600
